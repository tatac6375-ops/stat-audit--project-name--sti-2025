...
|---|---|---|---|
| RQ1 | Berapa probabilitas Pull Request di pandas-dev/pandas berhasil di-merge? | Bernoulli MLE + CI | θ̂ = 0,62098. Beta Posterior = Beta(2511, 1533), posterior mean = 0,62092. Probabilitas Pull Request berhasil di-merge pada repositori pandas-dev/pandas diperkirakan sekitar 62%. Hasil Bayesian dan MLE memberikan nilai yang hampir identik, menunjukkan estimasi yang stabil dan konsisten. + `Berdasarkan teknik Bernoulli MLE, probabilitas Pull Request berhasil di-merge adalah 62,09%. Dari data Beta Posterior (2511 sukses, 1533 gagal), kita mengetahui bahwa total sampel adalah 4.044 PR. Dengan sampel sebesar ini, nilai Confidence Interval (CI) 95% berada di rentang yang sangat sempit, yaitu antara 60,5% hingga 63,5%. Sempitnya rentang CI inilah yang menjadi dasar kesimpulan bahwa estimasi 62% tersebut sangat stabil dan konsisten |
